...
const Footer = () => {
  const socialLinks = [
    ...
    {
      name: "Email",
      href: "mailto:sureshphilips78@gmail.com",
      icon: (
          ...
          >
            {socialLinks.map((social) => (
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="w-10 h-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-neon-purple/20 transition-colors"
